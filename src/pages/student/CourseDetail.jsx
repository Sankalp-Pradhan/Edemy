    ...
    < >
      <div className='flex  md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          <h1 className='md:text-course-detail-heading-large text-course-detail-heading-small font-semibold text-gray-800'>{courseData.courseTitle}</h1>
          <p className='pt-4 md:text-base text-sm'
            dangerouslySetInnerHTML={{ __html: courseData.courseDescription.slice(0, 200) }}></p>

          {/* reviw and ratings */}
          <div className='flex ml-1 items-center space-x-2 pt-1 pb-1 text-sm'>
          ...
          <p className='text-sm'>Course by <span>XYZ Educator</span></p>

          <div className='pt-8 text-gray-800'>
            <h2 className='text-xl font-semibold'>Course Structure</h2>
            <div className='pt-5'>
              {courseData.courseContent.map((chapter, index) => (
                <div className='border border-gray-400 bg-white mb-2 rounded' key={index}>
