...
const SearchBar = ({ data }) => {
  ...
  return (
    <form onSubmit={onSearchHandler} className='max-w-xl w-full md:h0-14 h-12 flex items-centerbg-white border border-gray-500/20 rounded'>
      <img src={assets.search_icon} alt="search_icon" className='md:w-10 w-10 px-3 bg-white' />
